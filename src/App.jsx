        ...
        <div>
            <header class="p-4 flex flex-row justify-between items-center bg-[rgb(225,225,225)]">
                <div class="flex flex-row gap-4 justify-center items-center">
                    <img src={icon} alt="Propulsion UI" class="w-10 h-10" />
                ...
                <div class="pt-16 pb-16 flex flex-col gap-4">
                    <FrameSolid>
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="md:w-1/3">
                                <ButtonWithInlineText buttonText="Copy" text="npm install @theluqmn/propulsion-ui" href="https://github.com/theluqmn/propulsion-ui" onClick={() => {
                                    navigator.clipboard.writeText("npm install @theluqmn/propulsion-ui")
                                }} />
                            </div>
                        </div>
                    </FrameSolid>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 justify-between">
                        <FrameSolid>
                            <div class="flex flex-col gap-4">
                                ...
                                <Button text="Launch Now" onClick={() => {
                                    window.open("https://github.com/theluqmn/propulsion-ui", "_blank")
                                }} />
                            </div>
                        ...
                        <FrameSolid>
                            <div class="flex flex-col gap-4">
                                ...
                                <ButtonSolid text="Click me!" onClick={() => {
                        ...
                        <FrameSolid>
                            <div class="flex flex-col gap-4">
                                ...
                                <ButtonWithInlineText buttonText="Open" text="github repository" href="https://github.com/theluqmn/propulsion-ui" onClick={() => {
                                    window.open("https://github.com/theluqmn/propulsion-ui", "_blank")
                                }} />
                            </div>
                        </FrameSolid>
